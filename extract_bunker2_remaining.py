...
# Page IDs for Bunker 2 (25 total, 1 already extracted)
BUNKER_2_IDS = [
    "611169a11eaa82a4925a812558003328",  # already extracted
...
print("\n" + "="*80)
print("BUNKER 2 - Extraindo 24 URLs restantes")
print("="*80)
print(f"\nPage IDs para processar: {len(BUNKER_2_IDS)-1} (excluindo o já extraído)")
print("\nPróximo passo:")
print("Para cada page_id abaixo, execute: notion-fetch(id=[page_id])")
print("Extraia a URL do campo 'Nome' com o padrão:")
print('r\'"Nome":"<mention-page url=\\"(https://www\\.notion\\.so/[a-f0-9]+)\\"\')

for i, page_id in enumerate(BUNKER_2_IDS[1:], 1):
    print(f"{i:2d}. notion-fetch(id={page_id})")
